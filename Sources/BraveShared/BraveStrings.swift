...
extension Strings {
  ...
  public static let blockCookieConsentNoticesPopupDescription = NSLocalizedString(
    "BlockCookieConsentNoticesPopupDescription", tableName: "BraveShared", bundle: .strings,
  ...
  public static let yesBlockCookieConsentNotices = NSLocalizedString(
    "YesBlockCookieConsentNotices", tableName: "BraveShared", bundle: .strings,
  ...
  public static let noThanks = NSLocalizedString(
    "NoThanks", tableName: "BraveShared", bundle: .strings,
    value: "No thanks",
