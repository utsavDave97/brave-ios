window.__firefox__.includeOnce("WebStorePrivateAPI", function() {
  (function() {
    // MARK: - Native
    function postMessage(name, data) {
      if (window.webkit.messageHandlers.$<handler>) {
        ...
        console.log("INVALID MESSAGE HANDLER: $<handler>")
      }
      return null;
    }
    ...
    Object.defineProperty(window, 'chrome', {
      ...
      value: {
        loadTimes: function() {
          return {
            commitLoadTime: 1650894652.985,
            connectionInfo: "h3",
            finishDocumentLoadTime: 1650894653.216,
            finishLoadTime: 1650894653.31,
            firstPaintAfterLoadTime: 0,
            firstPaintTime: 1650894653.115,
            navigationType: "Other",
            npnNegotiatedProtocol: "h3",
            requestTime: 1650894652.843,
            startLoadTime: 1650894652.843,
